...
//console.log(protect_email("pat@example.com"));
...
Use new RegExp(string) to build a regEx dynamically (using a variable). The literal /../ form cannot be used with dynamic content.
*/
